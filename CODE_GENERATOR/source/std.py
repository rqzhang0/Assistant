...
# declaration and some basic operation is cumberson, I don't want to implement it 
#right now. However, in the future I'd like to implement it like this:
# var[[int,a,b,c..],[double,a,b,c..],[pointer,...]]
#then this program should give a set of variables
